...
class SAU:
    def __init__(self):
        ...
        # Интеграл ошибки
        self.Integral_H = 0
        # Заданное значение положения дросселя для ВМГ 1,2,3,4
        self.P_reg = 0
        # Заданный угол отклонения элеронов второго крыла sigma_3,sigma_4
    ...
    # Шаблонная функция вычисления заданного отклонения элеронов второго крыла для регулирования высоты 
